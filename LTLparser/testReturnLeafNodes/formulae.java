...
abstract class FormulaNode { 
    ...
    abstract public Set<String> returnLeafNodes(Set<String> set);
...
class ProgramNode extends FormulaNode {
    ...
    public Set<String> returnLeafNodes(Set<String> set) {
    	return myLTLList.returnLeafNodes(set);
    }
    ...
    public Set<String> returnLeafNodes(Set<String> set) {
        ...
        try {
            while (it.hasNext()) {
               ...
               set.addAll( ((LTLNode)it.next()).returnLeafNodes(tempSet));
            }
        } catch (NoSuchElementException ex) {
            System.err.println("unexpected NoSuchElementException in DeclListNode.print");
            System.exit(-1);
...
abstract class UnaryLTLNode extends LTLNode {
    ...
    public Set<String> returnLeafNodes(Set<String> set) {
    	return myLTL.returnLeafNodes(set);
    }
...
abstract class BinaryLTLNode extends LTLNode {
    ...
    public Set<String> returnLeafNodes(Set<String> set) {
    	...
    	hset.addAll(myLTL1.returnLeafNodes(set)); 
        hset.addAll(myLTL2.returnLeafNodes(set));
        return set;
    }
