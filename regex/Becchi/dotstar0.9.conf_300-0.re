...
'Host\\x3A.*Host\\x3A\\s+www\\x2Eyoogee\\x2Ecom\x13'
'Host\\x3A.*NETObserve\\d+Host\\x3aohgdhkzfhdzo\\x2fuwpOK\r\n'
'Host\\x3A.*Peer.*Host\\x3ABasicurl=http\\x3A\x1b'
...
'Host\\x3A[^\n\r]*Travel[^\n\r]*From\\x3Awww\\x2EZSearchResults\\x2Ecom\x13'
...
'Information.*Firewall\\s+ised2k\\xc0STATUS\\xc0Server\x13'
...
'PASSW=.*www\\x2Emakemesearch\\x2Ecom.*HBand,X-Mailer\\x3A\x13'
'PASSW=\\s+\\x2Fta\\x2FNEWS\\x2F.*loomcompany\\x2Ecom'
'PORT\\x3D\\s+User-Agent\\x3A\\s+ProAgentUI2Host\\x3A00000www\\x2Ezhongsou\\x2Ecom'
'Peer\\s+CodeguruBrowser.*UNSEEN\\x22Host\\x3Ahirmvtg\\x2fggqh\\.kqh\x1b'
...
'PromulGate\\s+SbAts.*Uservclxatmlhavj\\x2fvsywww\\x2Evip-se\\x2Ecom\x13'
...
'Referer\\x3A.*notification\x13.*qisezhin\\x2fiqor\\.ym\x13spasServer\\x3a'
...
'SoftActivity\x13\\s+User-Agent\\x3A.*LogsHost\\x3AHost\\x3AX-Mailer\\x3a\x13'
'Software\\s+User-Agent\\x3A.*FictionalUser-Agent\\x3AUser-Agent\\x3a'
'SpyAgent\\d+nick_name=CIA-Test\\d+url=http\\x3A\x1b\\d+\\x2FNFO\\x2CRegistered\\x28BDLL\\x29\x13'
'SpyAgent\\d+sErver\\s+User-Agent\\x3A'
'Spy\\s+\\x0d\\x0a.*YAHOOdestroyed\\x21Host\\x3a'
'Spynova\\s+ZC-Bridge.*Host\\x3A\\s+TPSystemHost\\x3AHost\\x3ashow\\x2Eroogoo\\x2EcomX-Mailer\\x3A\x13'
'SpywareStrike.*Subject\\x3A\\s+Pcast\\x2Edat\\x2EToolbar'
'Spyware\\s+ToolBar\\s+User-Agent\\x3AMM_RECO\\x2EEXEToClientonAlert'
'Strip-Player\x1b.*MyAgent.*\\x2Fnewsurfer4\\x2F'
'Subject\\x3A[^\n\r]*Arrow[^\n\r]*whenu\\x2Ecom\x13'
...
'This\\s+\\x7D\\x7BPassword\\x3A\x1b\\d+'
...
'Web-Mail\\s+\\x2Fcgi\\x2Flogurl\\.cgi.*Surveillance\x13Host\\x3a'
'Word\\w+My\\s+\\x22TheZC-BridgeUser-Agent\\x3AserverUSER-Attached'
'X-Mailer\\x3a\x13.*User-Agent\\x3A[^\n\r]*ulmxct\\x2fmqoyc'
'X-Mailer\\x3a\x13[^\n\r]*Host\\x3A\\s+cyber@yahoo\\x2Ecom'
'X-Mailer\\x3a\x13wlpgskmv\\x2flwzo\\.qv#Subject\\x3aActivity'
...
'\\x28BDLL\\x29\x13\\s+CD\\x2F.*Host\\x3A'
...
'\\x2Fcgi\\x2Flogurl\\.cgi.*User-Agent\\x3A.*Host\\x3Awww\\x2EZSearchResults\\x2Ecom\x13'
'\\x2Fcgi\\x2Flogurl\\.cgi\\s+IDENTIFY.*max-www\\x2Eu88\\x2Ecn'
'\\x2Fcommunicatortb[^\n\r]*\\x2FGR.*Reportinfowhenu\\x2Ecom\x13'
...
'\\x2Ftoolbar\\x2Fsupremetb\\s+wjpropqmlpohj\\x2flo\\s+resultsmaster\\x2Ecom\x13'
...
'devSoft\\x27s\x13\\s+Host\\x3A\\s+Host\\x3A'
...
'gdvsotuqwsg\\x2fdxt\\.hdFrom\\x3ahirmvtg\\x2fggqh\\.kqh\x1b'
...
'smrtshpr-cs-\x13.*TPSystem\\s+dist\\x2Eatlas\\x2Dia\\x2Ecom'
...
'subject\\x3A.*Login\\s+adfsgecoiwnf\x1b'
